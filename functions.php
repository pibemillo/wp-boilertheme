<?php
/**
 * ipseity functions and definitions
 *
...
function ips_setup() {
	 ...
	 * If you're building a theme based on ipseity, use a find and replace
	...
	add_theme_support( 'custom-background', apply_filters( 'ips_custom_background_args', array(
...
function ips_scripts() {
	...
	wp_register_style('google/fonts',
		'https://fonts.googleapis.com/css?family=Playfair+Display|Raleway',
		false, null);
